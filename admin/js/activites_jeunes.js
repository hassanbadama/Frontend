...
Afficher_activites_jeunes()

//Afficher  activite
function Afficher_activites_jeunes() {
  ...
  fetch("http://localhost:3000/api/auth/Afficher_activites_jeunes")
    .then((res) => res.json())
    .then((data) => {
      console.log("Affiche activites_jeunes");
      console.log(data);
