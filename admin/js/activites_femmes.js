...
function Enregistrer_activite(tableau, jour_activite, date_activite, image) {
  ...
  fetch("http://localhost:3000/api/auth/activites_femmes", {
    method: 'POST',
    ...
    .then((data) => {
      if (data.erreur) {
        ...
        document.location.href = `activites_femmes.html`;
...
function Afficher_activites_femmes() {
  ...
  fetch("http://localhost:3000/api/auth/Afficher_activites_femmes")
    .then((res) => res.json())
    .then((data) => {
      ...
      suppression_activites_femmes()
      modifier_activites_femmes()
      supprimer_champ()
    });
...
//supprimer activite
function suppression_activites_femmes() {
  ...
  supprimer.forEach((el) => {
    ...
    el.addEventListener("click", function (event) {
      ...
      document.querySelector(".oui").addEventListener("click", function (event) {
        fetch(`http://localhost:3000/api/auth/suppression_activites_femmes/${id}`, {
          method: "DELETE",
...
//modifier activite
function modifier_activites_femmes() {
  ...
  modifier.forEach((el) => {
    el.addEventListener("click", function (event) {
      ...
      document.querySelector(".oui_modifier").addEventListener("click", function (event) {
        ...
        fetch(`http://localhost:3000/api/auth/Recherche_pour_supprimer_activites_femmes/${id}`)
          .then((res) => res.json())
          .then((data) => {
  ...
  document.querySelector(".valider_modification").addEventListener("click", function (event) {
    ...
    if (validation_modification) {
      fetch(`http://localhost:3000/api/auth/modifier_activites_femmes/${id}`, {
        method: 'put',
        headers: {
